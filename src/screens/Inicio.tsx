...
export function Inicio({ onIr, onContinuar, onEmpezar, embedded = false }: {
  ...
  return <div className="pila editorial-home">
    ...
    <div className="home-paths">
      <button className="home-path home-path-photo" onClick={() => onIr('modulos')}><MedicalImage scene="membrane" sizes="(max-width: 760px) 100vw, 40vw" /><span className="home-path-copy"><span className="editorial-eyebrow">Biblioteca de estudio</span><strong>Elegir contenido</strong><span>Explora por sistema y disciplina.</span></span><NavigationIcon name="arrow" /></button>
