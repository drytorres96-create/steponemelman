  ...
  return (
    <div className="pila">
      ...
      <div className="fila" style={{ justifyContent: 'space-between', alignItems: 'flex-end' }}>
        <ScreenHeading landscape="lens" eyebrow="Revisión del material" title="Panel de auditoría" description="El corpus necesita revisión continua. Aquí se ve la fuente y el concepto lado a lado, con sus alertas." />
        <div className="fila">
