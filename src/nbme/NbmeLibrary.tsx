...
export function NbmeLibrary({ onStart }: { onStart: () => void }) {
  ...
  return <div className="nbme-library pila">
    <ScreenHeading eyebrow="Del concepto al razonamiento" title="Preguntas de aplicación" artwork="stone" subject="crystal" description="Practica con las formas 27, 28 y 29 y repasa los fundamentos que necesites." />
