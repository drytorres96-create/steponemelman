...
La versión de código **1.5.0** simplifica el estudio: tres destinos principales, avance directo, ayudas opcionales, filtros y duración compartidos, y un único plan diario. Conserva la IA y las variantes del piloto. Consulta [Cambios de la versión](docs/cambios-1.5.0.md). La versión aparece en **Cuenta y ajustes → Ajustes y respaldo**.
...
Las comprobaciones y los cambios de comportamiento de esta entrega están documentados en [la versión 1.5.0](docs/cambios-1.5.0.md). La prueba del corpus privado se ejecuta al publicar y se omite en CI si no se aportan esos archivos.
